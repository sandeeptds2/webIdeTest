sap.ui.define([
	...
	return Controller.extend("furnitureshop_reviews_app.furnitureshop_reviews_app.controller.products_list", {
		/**
		...
		formatIconSource: function (pictureName) {
			var headerPath = "/furnitureshop_reviews_app/resources/icons/ico_";
