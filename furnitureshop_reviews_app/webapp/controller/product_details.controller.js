sap.ui.define([
	...
	return Controller.extend("furnitureshop_reviews_app.furnitureshop_reviews_app.controller.product_details", {
		...
		formatImageSource: function (pictureName) {
			var headerRelativePath = "/furnitureshop_reviews_app/resources/images/";
			var completePath = headerRelativePath + pictureName;
			return completePath;
		},
